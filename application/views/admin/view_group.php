...
<div class="white-area-content">
   ...
   <table class="table table-bordered">
      ...
      <tr>
         ...
         <td><a href="<?php echo site_url("admin/remove_user_from_group/" . $r->userid . "/" . $r->groupid . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs"><?php echo lang("ctn_130") ?></a></td>
      </tr>
      <?php endforeach; ?>
   </table>
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-9">
                     ...
                     <select data-placeholder="Select.." name='usernames[]' id="email-in" class="form-control" multiple="multiple" required="required">
                        <option value=''>Select..</option>
                        <?php
                        foreach ($non_group_user_list->result() as $key => $user) {
