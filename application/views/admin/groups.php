                  ...
                  <div class="col-md-9">
                     ...
                     <div class="company-block">
                        ...
                        foreach ($company_list as $key => $value) {
                           echo '<div><input type="checkbox" name="company_list[]" value="'.$value->SendCompany.'"> '.$value->SendCompany.'</div>';
                        }
                        ?>
                     </div>
                  </div>
