...
//$this->user->info->admin_payment
            ...
            <?php 
            if($this->user->loggedin && isset($this->user->info->user_role_id) && ($this->user->info->ur_name == "Admin" || $this->user->info->ur_name == "Member") ) : ?>

            <?php
            if($this->user->info->ur_name == "Member") { ?>

            <li class="<?php if($this->uri->segment(1)=="orders" && $this->uri->segment(2) =="overview"){echo "active";}?>"><a href="<?php echo site_url('orders/overview') ?>"><span class="glyphicon glyphicon-dashboard sidebar-icon sidebar-icon-blue"></span> Overview <span class="sr-only">(current)</span></a></li>
            

            <?php } else { ?>
            
            <li class="<?php if(isset($activeLink['home']['general'])) echo "active" ?>"><a href="<?php echo site_url() ?>"><span class="glyphicon glyphicon-dashboard sidebar-icon sidebar-icon-blue"></span> <?php echo lang("ctn_154") ?> <span class="sr-only">(current)</span></a></li>

            <li class="<?php if($this->uri->segment(1)=="orders" && $this->uri->segment(2) =="overview"){echo "active";}?>"><a href="<?php echo site_url('orders/overview') ?>"><span class="glyphicon glyphicon-dashboard sidebar-icon sidebar-icon-blue"></span> Order Overview <span class="sr-only">(current)</span></a></li>



            <li class="<?php if($this->uri->segment(1)=="orders" && $this->uri->segment(2) ==""){echo "active";}?>"><a href="<?php echo site_url() ?>orders"><span class="glyphicon glyphicon-shopping-cart sidebar-icon sidebar-icon-blue"></span> Orders <span class="sr-only">(current)</span></a></li>
            <?php } ?>
            <!--
            ...
            <?php 
            if($this->user->loggedin && isset($this->user->info->user_role_id) &&  ($this->user->info->ur_name == "Order Manager") ) : ?>
            ...
            <?php 
            if($this->user->loggedin && isset($this->user->info->user_role_id) &&  ($this->user->info->ur_name == "Admin") ) : ?>
