...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Forget Password - WooDash</title>
                        ...
                        <div class="d-flex flex-column h-100">
                           ...
                           <div class="my-auto login-block">
                              <div class="pb-2">
                                 ...
                                 <p class="text-muted"><?php echo lang("ctn_175") ?>.</p>
                              </div>
                             ...
                             <?php $gl = $this->session->flashdata('globalmsg'); ?>
                              ...
                              <div class="mt-4">
                                 <?php echo form_open(site_url("login/forgotpw_pro/")) ?>
                                    ...
                                    <div class="mt-3">
                                       <button class="btn btn-primary btn-block waves-effect waves-light" type="submit"><?php echo lang("ctn_176") ?></button>
                                    </div>
                                 </form>
                              </div>
                           </div>
