...
class Admin extends CI_Controller 
{
	...
	public function user_groups() 
	{
		...
		$company_list =  $this->admin_model->company_list();
	...
	public function add_group_pro() 
	{
		...
		$company_list = implode(',', $this->input->post("company_list"));
		...
		$this->admin_model->add_group(
			array(
				"name" =>$name,
				"default" => $default,
				"access_company_orders" => $company_list
				)
			);
	...
	public function view_group($id, $page=0) 
	{
		...
		$non_group_user_list = $this->admin_model->get_user_from_not_in_group($id);
		...
		$this->template->loadContent("admin/view_group.php", array(
			"group" => $group->row(),
			"users" => $users,
			"non_group_user_list" => $non_group_user_list,
