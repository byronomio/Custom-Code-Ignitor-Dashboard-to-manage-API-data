...

{
	...
	public function index()
	{
		...
		return $this->load->view('login/index.php');
	...
	public function design(){
		...
		return $this->load->view('login/_index.php');
	}
...

	{
		...
		return $this->load->view('login/resetpw.php', array(
...

	{
		...
		return $this->load->view('login/forgotpw.php');
